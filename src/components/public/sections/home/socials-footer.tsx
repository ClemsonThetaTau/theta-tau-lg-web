    ...
    <div className="relative w-full h-96 bg-bottom bg-cover bg-fixed bg-[url('/images/photos/death-valley-balloons.jpg')]">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
        ...
        <div className="flex flex-row items-center justify-center space-x-4">
            <SocialButton icon={<AiFillFacebook size={40} />} link='https://www.facebook.com/ClemsonThetaTau/'/>
            <SocialButton icon={<AiFillInstagram size={40} />} link='https://www.instagram.com/clemsonthetatau'/>
            <SocialButton icon={<AiFillMail size={40} />} link='mailto:lambda.gamma@thetatau.org'/>
        </div>
      </div>
    </div>
  )
